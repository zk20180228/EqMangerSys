...
public class T_OPWork {
	...
	public String toString() {
		return "T_OPWork [id=" + id + ", area_name=" + area_name + ", room_id="
				+ room_id + ", room_name=" + room_name + ", p_name=" + p_name
				+ ", p_num=" + p_num + ", p_dept=" + p_dept + ", p_sex="
				+ p_sex + ", p_old=" + p_old + ", p_diagnose=" + p_diagnose
				+ ", ops_anme=" + ops_anme + ", ops_doctor=" + ops_doctor
				+ ", ops_doctor_id=" + ops_doctor_id + ", ops_mzdoctor="
				+ ops_mzdoctor + ", ops_mzdoctor_id=" + ops_mzdoctor_id
				+ ", ops_time=" + ops_time + ", ops_state=" + ops_state
